...
public class ConsultaProductos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        productoQuery = java.beans.Beans.isDesignTime() ? null : basededatosnegocioPUEntityManager.createQuery("SELECT p FROM Producto p");
        productoList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : productoQuery.getResultList();
        productoQuery1 = java.beans.Beans.isDesignTime() ? null : basededatosnegocioPUEntityManager.createQuery("SELECT p FROM Producto p");
        productoList1 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : productoQuery1.getResultList();
        productoQuery2 = java.beans.Beans.isDesignTime() ? null : basededatosnegocioPUEntityManager.createQuery("SELECT p FROM Producto p");
        productoList2 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : productoQuery2.getResultList();
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, productoList2, jTable1);
        ...
        columnBinding.setColumnClass(Integer.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${fechaModificacion}"));
    ...
    private java.util.List<vista.consulta.Producto> productoList;
    private java.util.List<vista.consulta.Producto> productoList1;
    private java.util.List<vista.consulta.Producto> productoList2;
    private javax.persistence.Query productoQuery;
    private javax.persistence.Query productoQuery1;
    private javax.persistence.Query productoQuery2;
