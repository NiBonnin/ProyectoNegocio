...
public class Main {
    ...
    public static void main(String[] args){
       ...
       // vista.setVisible(true);
        ...
        Cliente cliente3 = new Cliente(5,"Martin", "dr clark 385", "3260", "86484",15531,1.2,51.0);
        Cliente cliente4 = new Cliente("Josecito", "dr clark 385", "3260", "86484",15531,1.2,51.0);
        Fecha date = new Fecha();
        
        Producto produc1 = new Producto("Matesuli", "Un mate dorado del sol",date.getTimeDate() , 18.2, 5, 2, 4, 7, true, date.getTimeDate());
